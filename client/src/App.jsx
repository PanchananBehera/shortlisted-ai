// src/App.jsx - PRODUCTION READY with Mobile Navigation & Theme Support
...
import PacoBoard from './pages/PacoBoard';
  ...
  return (
    <Router>
      <ThemeProvider> {/* ✅ Wrap with ThemeProvider FIRST */}
        <AuthProvider>
          <RealTimeProvider>
            {/* ✅ MOBILE NAV PADDING FIX: pb-20 for bottom nav space, md:pb-0 for desktop */}
            {/* ✅ Global bg + transition handled here */}
            <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-20 md:pb-0 transition-colors duration-300">
              <Routes>
                {/* ===== PUBLIC ROUTES ===== */}
                ...
                {/* ✅ PacoBoard - Gamification & Progress */}
